...
translate.AddLocalization("description_deadeye", {
    ...
    ["zh-CN"] = "一个臭名昭著的雇佣兵弓箭手,被复生后继续为着不死者继续工作.\n它携带的短弓上布满倒勾以挂在血肉之中 同时燃烧箭头亦可点燃防线."
})
translate.AddLocalization("description_skeleton_archer", {
    ...
    ["zh-CN"] = "一名被遗忘在过去的弓箭手. /n使用弓箭与燃烧箭头将防线点燃."
})
...
translate.AddLocalization("description_shadow_lurker", {
    ...
    ["zh-CN"] = "它很难在黑暗中被发现, 而且对近战攻击有更高抗性. 被击中的人类会获得exhaust和vision dimming debuff."
})
translate.AddLocalization("description_abyss_lurker", {
    ...
    ["zh-CN"] = "一种抗性更高的暗影潜伏者, 可以投掷有confusion的深渊球."
})
...
translate.AddLocalization("description_eradicator", {
    ...
    ["zh-CN"] = "死亡和破坏的先锋. 铲除者强壮的身躯需要很强火力才能击垮.\n如果没有被爆头就很难被放倒."
})
...
translate.AddLocalization("description_parasite", {
    ...
    ["zh-CN"] = "由两个血腥生物组成的鲜红造物. 非常敏捷和危险, 可以击倒滞空的目标."
})
...
translate.AddLocalization("description_ice_fiend", {
    ...
    ["zh-CN"] = "极寒极黑的恶魔实体. \n它的爪子和掷出的黏着物均可frost 与 dim vision人类"
})
...
translate.AddLocalization("description_gloom_walker", {
    ...
    ["zh-CN"] = "开始记录.Drummond医生,斯坦福堡东区病房.日期:12月5日*静脉注射*病人:第二大队中尉Boris Kowalchik.今天第二次会议提到.在我们加大药效剂量后,中尉的精神状态已有恢复迹象,而他的身体状况也将在几日完全恢复.虽然之前的调查中.我们怀疑他的视力损害是由于直视烟雾信号导致,但在我们收集回来的样本解析完成前,我们都不能确定.在中尉回返前,预测他的视力恢复也能伴随他精神状态恢复过来,这样我们便更好了解他和他的队伍都发生了些什么."
})
...
translate.AddLocalization("description_spectral_revenant", {
    ...
    ["zh-CN"] = "一个沉睡多年,饱受折磨的灵魂决定从它永恒的梦境中醒来,带给世人来自他们精神深处的打击"
})
translate.AddLocalization("description_fetid_maw", {
    ...
    ["zh-CN"] = "这只人见人恨的怪物散发着强烈的腐臭味,吐出的东西类似于它的远房表兄吐翔者和剧毒魔. 更糟糕的是,这种个体进化出了毒气囊,使其能飞在空中,并且能够从上方将毒气当作炸弹一样投掷下去"
})
...
translate.AddLocalization("description_harbinger", {
    ...
    ["zh-CN"] = "最后一只被目击到的脓包猎头鬼变异个体,也是迄今为止最致命的变异体……"
})
translate.AddLocalization("description_breachprowler", {
    ...
    ["zh-CN"] = "来自世界之外的存在....它徘徊在现实的边缘....期待着侵入"
})
...
translate.AddLocalization("description_cinder_thug", {
    ...
    ["zh-CN"] = "一个被火山岩,煤渣和岩浆覆盖的强大生物.冲刺时它的体温近乎提高2000摄氏度左右,更是有毁天灭地般的冲击力,以至于那些灼热的碎片会覆盖在它那崎岖的外表上.目前对cinder thug以及其喜好破坏的习性知之甚少."
})
translate.AddLocalization("description_cinder_ghoul", {
    ...
    ["zh-CN"] = "一个全身充斥着熔岩与火花的食尸鬼. 身体表现出一种罕见的特性, 可以让它产生高温肉块. 在承受足够的伤害后,体内的热能会使食尸鬼的身体变热,大大提高移动速度和攻击速度"
})
...
translate.AddLocalization("description_alphacrab", {
    ...
    ["zh-CN"] = "一种巨大的变种猎头蟹,会跳到受害者的身上碾碎他们.\n具有投掷孢子的能力,可以治愈丧尸并伤害人类."
})
